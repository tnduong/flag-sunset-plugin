...
Private VS Code agent plugin that provides the `/ld:flag-sunset` prompt for shared LaunchDarkly feature-flag sunset workflows.
...
```text
/ld:flag-sunset WFD-5487-display-strike-duplication
```
